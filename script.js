...
function iniTorneo(dataByColumn) {
    ...
    iniRound("finali road to 9", dataByColumn["finali r9 squadra A"], dataByColumn["finali r9 squadra A punteggio"], dataByColumn["finali r9 squadra B"], dataByColumn["finali r9 squadra B punteggio"], 1, 9);
